    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ShopContent.useEffect": ()=>{
            fetch("/api/categories").then({
                "ShopContent.useEffect": (res)=>res.json()
            }["ShopContent.useEffect"]).then({
                "ShopContent.useEffect": (data)=>{
                    if (data.categories) {
                        setCategories(data.categories);
                    }
                }
            }["ShopContent.useEffect"]).catch({
                "ShopContent.useEffect": (err)=>console.error("Categories load failed:", err)
            }["ShopContent.useEffect"]);
        }
    }["ShopContent.useEffect"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ShopContent.useEffect": ()=>{
            ...
            query.set("limit", "9");
            fetch(`/api/products?${query.toString()}`).then({
                "ShopContent.useEffect": (res)=>res.json()
            }["ShopContent.useEffect"]).then({
                "ShopContent.useEffect": (data)=>{
                    if (data.products) {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "flex flex-col gap-2.5",
                                        children: districts.map((dist)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                                className: "flex items-center gap-2.5 text-sm text-text-muted cursor-pointer hover:text-primary transition-colors",
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                                        type: "checkbox",
...
_s(ShopContent, "D1YUey/l0wvVMp1OzP0+BVlBKYM=", false, function() {
    return [
